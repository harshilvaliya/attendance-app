      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
          <div>
            ...
            <p className="text-muted-foreground">Manage company holidays and events</p>
          </div>
          <AddHolidayDialog>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{nextHoliday ? nextHoliday.name : "None"}</div>
          ...
          <TabsContent value="list" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View and manage all company holidays</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="calendar" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>View holidays in calendar format</CardDescription>
              </CardHeader>
              <CardContent>
